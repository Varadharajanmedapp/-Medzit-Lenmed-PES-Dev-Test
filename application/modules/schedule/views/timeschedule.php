                            ...
                            foreach ($schedules as $schedule) {
                                ...
                                <tr class="treatment-table">
                                    ...
                                    <td>
                                        ...
                                        -->
                                        <a class="btn btn-info btn-xs btn_width delete_button" href="schedule/deleteSchedule?id=<?php echo $schedule->id; ?>&doctor=<?php echo $doctorr; ?>&weekday=<?php echo $schedule->weekday; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img alt="" src="uploads/trash-bttn-icon.png" class="schedule-del-but"> <?php echo lang('delete'); ?></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
