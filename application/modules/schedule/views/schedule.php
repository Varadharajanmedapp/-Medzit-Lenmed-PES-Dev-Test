...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            ...
            <div class="col-md-6">
            <i>
            <img alt="" src="uploads/all-schedule-main.png" class="doc-list-doc-img">
            </i>
                                ...
                                <tr class="">
                                    ...
                                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                        <td>
                                            ...
                                            -->
                                            <a class="btn btn-info btn-xs btn_width delete_button" href="schedule/deleteSchedule?id=<?php echo $schedule->id; ?>&doctor=<?php echo $schedule->doctor; ?>&weekday=<?php echo $schedule->weekday; ?>&all=all" onclick="return confirm('Are you sure you want to delete this item?');"><img alt="" src="uploads/trash-bttn-icon.png" class="schedule-del-but">  <?php echo lang('delete'); ?></a>
                                        </td>
                                    <?php } ?>
                                </tr>
                            <?php } ?>
...
<script>
    $(document).ready(function () {
        ...
        $("#Schedulechoose").select2({
            placeholder: '<?php echo lang('select_Schedule'); ?>',
            allowClear: true,
            ajax: {
