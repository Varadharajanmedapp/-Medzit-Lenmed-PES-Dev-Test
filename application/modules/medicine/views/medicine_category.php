                    ...
                    <table class="table table-striped table-hover table-bordered table-row1" id="editable-sample">
                        ...
                        <?php foreach ($categories as $category) { ?>
                            <tr class="">
                                ...
                                <td>
                                    <button type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" data-id="<?php echo $category->id; ?>"> <img alt="" src="uploads/edit-bttn-icon.png" class="bed-edit-bttn-icon" ><?php echo lang('edit'); ?></i></button>   
                                    <a class="btn btn-info btn-xs btn_width delete_button" href="medicine/deleteMedicineCategory?id=<?php echo $category->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img alt="" src="uploads/trash-bttn-icon.png" class="bed-edit-bttn-icon"> <?php echo lang('delete'); ?></i></a>
                                </td>
                            </tr>
                        <?php } ?>
