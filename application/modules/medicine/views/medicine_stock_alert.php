                    ...
                    <table class="table table-striped table-hover table-bordered table-row1" id="editable-sample" >
                        <thead>
                            <tr>
                                ...
                                <th class="med-table1"> <?php echo lang('options'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        foreach ($medicines as $medicine) {
                            ...
                            <tr class="">
                                ...
                                <td>
                                    <button type="button" class="btn btn-info btn-xs btn_width editbutton width_auto1" data-toggle="modal" data-id="<?php echo $medicine->id; ?>"><img alt="" src="uploads/edit-bttn-icon.png" class="bed-edit-bttn-icon">  <?php echo lang('edit'); ?></button>   
                                    <a class="btn btn-info btn-xs btn_width delete_button width_auto1"   href="medicine/delete?id=<?php echo $medicine->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img alt="" src="uploads/trash-bttn-icon.png" class="bed-edit-bttn-icon"><?php echo lang('delete'); ?></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
