...
class Medicine extends MX_Controller {
    ...
    function getMedicineList() {
        ...
        foreach ($data['medicines'] as $medicine) {
            ...
            $option1 = '<button type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" data-id="' . $medicine->id . '"><img alt="" src="uploads/edit-bttn-icon.png" style=" height: 17px;"> ' . lang('edit') . '</button>';

            $option2 = '<a class="btn btn-info btn-xs btn_width delete_button" href="medicine/delete?id=' . $medicine->id . '" onclick="return confirm(\'Are you sure you want to delete this item?\');"><img alt="" src="uploads/trash-bttn-icon.png" style=" height: 17px;">' . lang('delete') . '</a>';
            $info[] = array(
                $i,
                $medicine->name,
                $medicine->category,
