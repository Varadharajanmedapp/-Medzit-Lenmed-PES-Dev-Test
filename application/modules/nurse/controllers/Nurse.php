...
class Nurse extends MX_Controller {
    ...
    public function addNew() {
        ...
        $this->form_validation->set_rules('email_verification', 'Email OTP', 'trim|required|min_length[4]|max_length[100]|xss_clean');
        ...
        $this->form_validation->set_rules('phone_verification', 'Phone OTP', 'trim|required|min_length[4]|max_length[100]|xss_clean');
