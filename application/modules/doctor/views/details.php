                                                ...
                                                if (!empty($patient_details)) {
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="no-print">
                                                            ...
                                                            <a class="btn btn-info btn-xs btn_width green" title="<?php echo lang('history'); ?>" href="patient/medicalHistory?id=<?php echo $todays_appointment->patient; ?>"><i class="fa fa-stethoscope"></i> <?php echo lang('patient'); ?> <?php echo lang('history'); ?></a>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($appointment_patients as $appointment_patient) {
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="no-print">
                                                            <a class="btn green" title="<?php echo lang('history'); ?>"  href="patient/medicalHistory?id=<?php echo $appointed_patient->id; ?>"><i class="fa fa-stethoscope"></i> <?php echo lang('history'); ?></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-samplee">
                                        ...
                                        <tbody> 
                                            ...
                                            foreach ($schedules as $schedule) {
                                                ...
                                                ?>
                                                <tr class="">
                                                    <td class="schedule-tab-bg"> <?php echo $i; ?></td> 
                                                    ...
                                                    <td>
                                                        <!--
                                                        <button type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" data-id="<?php echo $schedule->id; ?>"><i class="fa fa-edit"></i> <?php echo lang('e'); ?></button>   
                                                        -->
