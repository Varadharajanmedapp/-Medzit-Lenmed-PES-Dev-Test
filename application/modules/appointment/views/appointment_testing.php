                                        ...
                                        foreach ($appointments as $appointment) {
                                            if ($appointment->doctor == $doctor_id) {
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td>
                                                        <!--
                                                        <button type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" data-id="<?php echo $appointment->id; ?>"><i><img alt="" src="uploads/edit-bttn-icon.png"  style=" height: 25px; margin-left:-5px; " >  <?php echo lang('edit'); ?></i></button>   
                                                        -->

                                                        <a class="btn btn-info btn-xs btn_width delete_button" href="appointment/delete?id=<?php echo $appointment->id; ?>&doctor_id=<?php echo $appointment->doctor; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img alt="" src="uploads/trash-bttn-icon.png"  style=" height: 25px; margin-left:-5px; " > <?php echo lang('delete'); ?></a>
                                                    </td>
        ...
        var table = $('#editable-sample').DataTable({
            ...
            buttons: [
...

                {
                    ...
                    exportOptions: {
                        columns: [0, 1, 2, 3],
                        text: '< style="box-shadow:4px 0px 0px 0px gray">',
                    }
                },
            ],
            aLengthMenu: [
