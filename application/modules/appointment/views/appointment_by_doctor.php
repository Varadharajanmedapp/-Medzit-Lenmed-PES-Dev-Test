            ...
            <div class="">
                <div class="tab-content">
                    ...
                    <div id="calendardetails" class="tab-pane active">
                        <div class="">
                            <div class="panel-body" style="background:#ffff !important;margin-top:1px !important;">
                                <div class="col-md-12">
...
<?php
                                        foreach ($appointments as $appointment) {
                                            if ($appointment->doctor == $doctor_id) {
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td>
                                                        <!--
                                                        <button type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" data-id="<?php echo $appointment->id; ?>"> <i> <?php echo lang('edit'); ?></i></button>   
                                                        -->
                                                        <a class="btn btn-info btn-xs btn_width delete_button" href="appointment/delete?id=<?php echo $appointment->id; ?>&doctor_id=<?php echo $appointment->doctor; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img alt="" src="uploads/trash-bttn-icon.png" ></a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
        ...
        <section class="col-md-4">
            ...
            <section class="">
                <div class="panel-body profile" style="background:#ffff;margin-top:1px;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i><img alt="" src="uploads/edit-bttn-icon.png" style=" "></i>  <?php echo lang('edit_appointment'); ?></h4>
            </div>
