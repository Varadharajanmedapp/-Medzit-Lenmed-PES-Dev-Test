                    ...
                    <table class="table table-striped table-hover table-bordered table-row1" id="editable-sample">
                        ...
                        <?php foreach ($donors as $donor) { ?>
                            <tr class="">
                                ...
                                <?php if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Laboratorist', 'Doctor'))) { ?>
                                    <td class="no-print">
                                        <button type="button" class="btn btn-info btn-xs btn_width editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $donor->id; ?>"><img alt="" src="uploads/edit-bttn-icon.png" class="bed-edit-bttn-icon">Edit</button>   
                                        <a class="btn btn-info btn-xs btn_width delete_button" title="<?php echo lang('delete'); ?>" href="donor/delete?id=<?php echo $donor->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img alt="" src="uploads/trash-bttn-icon.png" class="schedule-del-but">Delete</a>
                                    </td>
                                <?php } ?>
                            </tr>
                        <?php } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" action="donor/addDonor" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-3">
                        <label for="exampleInputEmail1"><?php echo lang('Blood_bag'); ?></label>
                        <input type="text" class="form-control" name="blood_bag" id="exampleInputEmail1" placeholder="">
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="editDonorForm" class="clearfix" action="donor/addDonor" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-3">
                        <label for="exampleInputEmail1"><?php echo lang('Blood_bag'); ?></label>
                        <input type="text" class="form-control" name="blood_bag" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-12">
                        <button type="submit" name="submit" class="btn btn-info pull-right"><?php echo lang('submit'); ?></button>
                    </div>
