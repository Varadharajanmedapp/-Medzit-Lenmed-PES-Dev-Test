                    ...
                    <table class="table table-striped table-hover table-bordered table-row1" id="editable-sample" >
                        ...
                        <?php foreach ($groups as $group) { ?>
                            <tr class="">
                                ...
                                <td>
                                   <button type="button" class="btn btn-info btn-xs btn_width editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $group->id; ?>"><img alt="" src="uploads/edit-bttn-icon.png" class="bed-edit-bttn-icon">Edit</button>   
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
