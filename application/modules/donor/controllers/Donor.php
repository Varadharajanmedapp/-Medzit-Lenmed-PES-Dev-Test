...
class Donor extends MX_Controller {
    ...
    public function addDonor() {
        ...
        $blood_bag = $this->input->post('blood_bag');
       ...
       // Validating Blood Bag Field
        $this->form_validation->set_rules('blood_bag', 'Blood Bag', 'trim|required|min_length[1]|max_length[100]|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->donor_model->updateBankB($blood_bag,$group);
