            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    <div class="clearfix">
                        ...
                        <form role="form" action="bed/addAllotment" class="clearfix row" method="post" enctype="multipart/form-data" autocomplete="off">
                           ...
                           <div class="form-group col-md-12">
                                ...
                                <div data-date="" class="input-group date form_datetime-meridian">
                                    <div class="input-group-btn"> 
                                        <button type="button" class="btn btn-info date-set date-set1"><i class="fa fa-calendar"></i></button>
                                        <button type="button" class="btn btn-danger date-reset date-set1"><i class="fa fa-times"></i></button>
                                    </div>
