                        ...
                        <div class="">
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered appoinment-tab-width3" id="editable-sample5">
                                        <thead>
                                            <tr>
                                                <th class="appoinment-tab-width3"> <?php echo lang('topic'); ?></th>
                    ...
                    <div id="requested" class="tab-pane">
                        <div class="">
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    <div class="space15"></div>
                                    <table class="table table-striped table-hover table-bordered appoinment-tab-width3" id="editable-sample6" >
                                        <thead>
                                            <tr>
...
<div class="modal fade" tabindex="-1" role="dialog" id="cmodal">
    <div class="modal-dialog modal-lg appoinment-tab-width6" role="document">
        <div class="modal-content">
            <!--
            <div class="modal-header">
