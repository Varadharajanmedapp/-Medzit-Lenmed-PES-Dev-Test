                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="superadmin/add_specialist" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <div class=""> 
                                                <label for="exampleInputEmail1"><?php echo lang('name'); ?></label>
                                                <input class="form-control" placeholder="Specialist Name" id="title" name="title" type="text" value="<?php echo set_value('title'); ?>" autocomplete="off"> 
                                            </div>
                                        </div>
