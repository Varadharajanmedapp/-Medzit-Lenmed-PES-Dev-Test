                        ...
                        <div class="col-lg-12">
                            <section>
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="superadmin/addOnboard" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class=""> 
                                                ...
                                                <input class="form-control" placeholder="slogan" id="slogan" name="slogan" type="text" value="<?php echo set_value('slogan'); ?>" autocomplete="off"> 
                                            </div>
                                        </div>
