...
<section id="main-content">
  <section class="wrapper site-min-height">
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="cmodal">
      <div class="modal-dialog modal-lg modal-lg1" role="document" >
    ...
    <?php if ($this->ion_auth->in_group(array('Doctor'))) { ?>
      <?php if (in_array('appointment', $this->modules)) { ?>
        <div class="state-overview col-md-5 state-overview-col5">
                    ...
                    if ($appointment->date == strtotime(date('Y-m-d'))) {
                      ...
                      <tr class="">
                        ...
                        <td>
                          ...
                          <a class="btn detailsbutton" title="<?php lang('history') ?>"class="detailsbutton1" href="patient/medicalHistory?id=<?php echo $appointment->patient ?>"><i class="fa fa-stethoscope"></i> <?php echo lang('history'); ?></a>
                        </td>
                      </tr>
                      <?php
                    }
    ...
    <?php if (!$this->ion_auth->in_group('superadmin')) { ?>
      <?php if (!$this->ion_auth->in_group('Doctor')) { ?>
        <div class="state-overview col-md-12 state-overview-col6" >
          <div class="clearfix">
            <?php if (in_array('doctor', $this->modules)) { ?>
              <div class="col-lg-3 col-sm-6" >
                <?php if ($this->ion_auth->in_group('admin')) { ?>
                  <a href="doctor">
                  <?php } ?>
                  <section class="panel home_sec_blue home_rectangle_box" >
                    <div class="symbol blue symbol_blue_1" >
                      <i> <img alt="" src="uploads/doctor23-icon.png"></i>
                    </div>
                    <div class="value value1"> 
                      ...
                      <p class="mainmenu-icon-text" ><?php echo lang('doctor'); ?></p>
                    </div>
                  </section>
                  <?php if (!$this->ion_auth->in_group('admin')) { ?>
                  </a>
                ...
                <?php if ($this->ion_auth->in_group('admin')) { ?>
                  ...
                  <section class="panel home_sec_blue">
                    <div class="symbol blue">
                      <i> <img alt="" src="uploads/patient23-icon.png"></i>
                    ...
                    <div class="value value1">
                      ...
                      <p class="mainmenu-icon-text" ><?php echo lang('patient'); ?></p>
                    </div>
                  </section>
                  <?php if ($this->ion_auth->in_group('admin')) { ?>
                  </a>
            ...
            <?php if (in_array('appointment', $this->modules)) { ?>
              <div class="col-lg-3 col-sm-6">
                <?php if ($this->ion_auth->in_group('admin')) { ?>
                  ...
                  <section class="panel home_sec_blue">
                    <div class="symbol blue">
                      <i> <img alt="" src="uploads/Appointment-icon.png"></i>
                    ...
                    <div class="value value1 ">
                      ...
                      <p class="mainmenu-icon-text"><?php echo lang('appointment'); ?></p>
                    </div>
                  </section>
                  <?php if ($this->ion_auth->in_group('admin')) { ?>
                  </a>
            ...
            <?php if (in_array('prescription', $this->modules)) { ?>
              <div class="col-lg-3 col-sm-6">
                <?php if ($this->ion_auth->in_group('admin')) { ?>
                  ...
                  <section class="panel home_sec_blue">
                    <div class="symbol blue">
                      <i> <img alt="" src="uploads/Prescription23-icon.png"></i>
                    ...
                    <div class="value value1" >
                      ...
                      <p class="mainmenu-icon-text"><?php echo lang('prescription'); ?></p>
                    </div>
                  </section>
                  <?php if ($this->ion_auth->in_group('admin')) { ?>
                  </a>
            ...
            <?php if (in_array('lab', $this->modules)) { ?>
              <div class="col-lg-3 col-sm-6">
                <?php if ($this->ion_auth->in_group('admin')) { ?>
                  <a href="lab/scan_report">
                  <?php } ?>
                  <section class="panel home_sec_blue">
                    <div class="symbol blue">
                    <i> <img alt="" src="uploads/Patient-PHR-icon.png"></i>
                    ...
                    <div class="value value1" >
                      ...
                      <p class="mainmenu-icon-text"><?php echo lang('patient_phr'); ?></p>
                    </div>
                  </section>
                  <?php if ($this->ion_auth->in_group('admin')) { ?>
                  </a>
            ...
            <?php if (in_array('finance', $this->modules)) { ?>
              <div class="col-lg-3 col-sm-6">
                <?php if ($this->ion_auth->in_group('admin')) { ?>
                  ...
                  <section class="panel home_sec_blue">
                    <div class="symbol blue">
                      <i> <img alt="" src="uploads/Patient-invoise-icon.png"></i>
                    ...
                    <div class="value value3">
                      ...
                      <p class="mainmenu-icon-text"><?php echo lang('payment'); ?> <?php echo lang('invoice'); ?></p>
                    </div>
                  </section>
                  <?php if ($this->ion_auth->in_group('admin')) { ?>
                  </a>
            ...
            <?php if (in_array('patient', $this->modules)) { ?>
              <div class="col-lg-3 col-sm-6 " style="display: none;">
                <section class="panel home_sec_blue">
                  <a href="">
                    <div class="symbol blue">
                      <i> <img alt="" src="uploads/today-revenue-icon.png"></i>
                  ...
                  <div class="value value2">
                    <h3 class="">
                      <?php
                      $this->db->select_sum('appointment.amount');
                      $this->db->from('appointment');
                      $this->db->where('appointment.transcation_id!=','');
                      $this->db->where('payment.status','paid');
                      $this->db->where('appointment.hospital_id', $this->session->userdata('hospital_id'));
                      $this->db->join('payment', 'appointment.transcation_id=payment.remarks');
                      $result = $this->db->get()->row();
                      echo $result->amount?$currency. ' '.$result->amount:$currency.' 0'; ?>
                    </h3>

                    <p class="mainmenu-icon-text"><?php echo lang('total_amount'); ?></p>
                  </div>
                </section>
              </div>
              <div class="col-lg-3 col-sm-6" >
                <section class="panel home_sec_blue">
                  ...
                  <div class="value value2">
                    <h3 class="">
                      ...
                      $this->db->where('appointment.transcation_id!=','');
                      $this->db->where('payment.status','paid');
                      $this->db->where('payment.date >=',$curr_date);
                      $this->db->where('appointment.hospital_id', $this->session->userdata('hospital_id'));
                      $this->db->join('payment', 'appointment.transcation_id=payment.remarks');
                      $result = $this->db->get()->row();
                      echo $result->amount?$currency. ' '.$result->amount:$currency.' 0'; ?>
                    ...
                    <p class="mainmenu-icon-text"><?php echo lang('today_amount'); ?></p>
                  </div>
                </section>
              </div>
              <div class="col-lg-3 col-sm-6">
                <?php if ($this->ion_auth->in_group('admin')) { ?>
                 <a href="postfinance/payment">
               <?php } ?>
               <section class="panel home_sec_blue">
                <div class="symbol blue">
                  <i> <img alt="" src="uploads/off-online-icon.png"></i>
                </div>
              </a>
              <div class="value value1" >
                <label class="switch">
                  ...
                  $is_online = $this->db->get('hospital')->result();
                    ?>
                  <input type="checkbox" id="check" <?php echo $is_online[0]->is_online=="online"? "checked": "" ;?>>
                  <span class="slider round switch"></span>
                </label>
                <p class="mainmenu-icon-text"><?php echo lang('offline/online'); ?></p>
              </div>
            </section>
          </div>
        <?php } ?>
        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
          <?php if (in_array('finance', $this->modules)) { ?>
            <div class="state-overview col-md-12 state-overview-col5">
          <div class="clearfix">
...
<?php } else { ?>
  ...
  <?php foreach ($hospitals as $hospital) { ?>    
    <div class="col-lg-6 col-md-12 col-sm-12">
      <section class="panel">   
        <div class="symbol super col-md-6 col-sm-6">
          <?php echo $hospital->name; ?>
        </div>
        <div class="value super1 col-md-6 col-sm-6"> 
          <p class="">
