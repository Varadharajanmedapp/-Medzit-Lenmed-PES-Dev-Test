...
<link rel="stylesheet" href="common/css/newGui.css" type="text/css" media="all">
        ...
        <div class="state-overview col-md-4 state-overview-col1" >
        ...
        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
            <div class="state-overview col-md-8 state-overview-col2" >
                <?php
            ...
            <div class="state-overview col-md-6 state-overview-col3">
            ...
            <div class="state-overview col-md-6 state-overview-col4" >
