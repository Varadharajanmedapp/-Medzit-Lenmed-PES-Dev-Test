        ...
        <div class="col-md-8 panel bg_container margin_top" id="prescription">
            <div class="bg_prescription">
                <div class="panel-body">
                    ...
                    <div class="col-md-4 pull-right text-right top_logo"> <img src="<?php echo $settings->logo; ?>" style="width:100% !important;"></div>
                </div>
                <hr>
                <div class="panel-body">
                    <div class="">
                        ...
                        <h5 class="col-md-3 prescription"><?php echo lang('appointment'); ?> <?php echo lang('id'); ?> : <?php echo $prescription->appointment_id; ?></h5>
                    </div>
                </div>
                ...
                <div class="panel-body prescription-panel1" >
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="panel-body">
                            <div class="prescription-panel2">
                                <strong class="prescription-text"> Rx </strong>
                            </div>
                            <?php
                ...
                <div class="panel-body">
                    <h5>
                        <strong><?php echo lang('report').' '.lang('image'); ?>: </strong> <br> <br> 
                        <?php if($prescription->report_img!='') { ?>
                            <img alt="" src="<?php echo $prescription->report_img; ?>" width="100%">
                        <?php }  ?>
                    </h5>
                </div>
            ...
            <div class="panel-body prescription_footer">
                <div class="col-md-4 pull-left pull-left-col-4"> <hr> <?php echo lang('signature'); ?></div>
...
<script>
                            ...
                            $('#download').click(function () {
                                ...
                                pdf.addHTML($('#prescription'),{ pagesplit: true }, function () {
