    ...
    <body>
      <section id="container">
        <section class="request-main-content" id="main-content" >
            <h4 class="request-h4-text">Register here to add your institution</h4>
      ...
      <div class="panel-body request-panel-body" >
        <div class="adv-table editable-table ">
          ...
          <form role="form" action="request/add_request" method="post" id="ajax_form" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-2">
          ...
          <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="email_verification" id="" value='' placeholder="">
          </div>
          </div>
        <div class="form-group">
...
<div class="form-group">
  ...
  <?php foreach ($packages as $package) { ?>
    <option data-module = "<?php echo $package->module; ?>" data-p_limit = "<?php echo $package->p_limit; ?>" data-d_limit = "<?php echo $package->d_limit; ?>" value="<?php echo $package->id; ?>" <?php
    if (!empty($setval)) {
...
<div class="text-center"> 
  ...
  <p class="footer">MedZit & PES are registered trademarks & copyright of Medappdynamics Pvt Ltd. All rights reserved. <br> Terms of Use | Privacy policy</p>
...
<script>
  $(document).ready(function () {
    ...
    //   e.preventDefault(); 
    // });
    // $(document.body).on('click', '.PaymentButton-contents', function () {
    //   var form = $("#ajax_form");
