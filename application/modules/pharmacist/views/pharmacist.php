    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <div class="col-md-6">
            <i><img alt="" src="uploads/pharmacist-main.png" class="doc-list-doc-img"></i>
                ...
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered table-row1" id="editable-sample" >
                        ...
                        <?php foreach ($pharmacists as $pharmacist) { ?>
                            <tr class="">
                                <td class="all-case-tab"><img style="width:95%;" src="<?php echo $pharmacist->img_url; ?>"></td>
                                ...
                                <td class="no-print">
                                    <button type="button" class="btn btn-info btn-xs btn_width editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $pharmacist->id; ?>"><img alt="" src="uploads/edit-bttn-icon.png" class="expense-edit-bttn-icon"> Edit</button>   
                                    <a class="btn btn-info btn-xs btn_width delete_button" href="pharmacist/delete?id=<?php echo $pharmacist->id; ?>" title="<?php echo lang('delete'); ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img alt="" src="uploads/trash-bttn-icon.png" class="expense-edit-bttn-icon"> Delete </a>
                                </td>
                            </tr>
                        <?php } ?>
                    ...
                    <label class="control-label"><?php echo lang('image'); ?><?php echo lang('upload'); ?></label>
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" class="dept-add-spec-fileupload1">
            ...
            <div class="modal-body">
                <form role="form" id="editPharmacistForm" class="clearfix" action="pharmacist/addNew" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('email'); ?><sup>*</sup></label>
                        <input type="text" class="form-control" name="email" id="exampleInputEmail1" value='' placeholder="" autocomplete="off">
                    </div>
...
$(document).ready(function() {
    $("#email_otp, #email_otp_edit").on("click", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url().'pharmacist/user_verification';?>", // Fixed missing quotes around the URL
