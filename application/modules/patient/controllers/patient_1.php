...
class Patient_1 extends MX_Controller {
    ...
    public function addNew() {
        ...
        $this->form_validation->set_rules('phone', 'Phone with the country code', 'trim|required|min_length[2]|max_length[50]|xss_clean');
        // Validating Email Field
        $this->form_validation->set_rules('sex', 'Gender', 'trim|required|min_length[2]|max_length[100]|xss_clean');
        // Validating Address Field   
