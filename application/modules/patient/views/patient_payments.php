...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            ...
            <i ><img alt="" src="uploads/payments-main.png" class="doc-list-doc-img"></i> <?php echo lang('patient'); ?> <?php echo lang('payments'); ?>
            </div>
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".editbutton", function () {
        ...
        $.ajax({
            ...
            $('#editPatientForm').find('ame="address"]').val(response.patient.address).end()
            $('#editPatientForm').find('[name="phone"]').val(response.patient.phone).end()
            $('#editPatientForm').find('[name="sex"]').val(response.patient.sex).end()
            $('#editPatientForm').fin[name="id"]').val(response.patient.id).end()
