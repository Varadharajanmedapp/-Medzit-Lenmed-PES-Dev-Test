                        ...
                        foreach ($patients as $patient) {
                            ...
                            if (in_array($doctor_id, $patient_doctors)) {
                                ...
                                <tr class="">
                                    ...
                                    <td class="no-print">
                                        <a type="button" class="btn editbutton" title="<?php echo lang('edit'); ?>" data-toggle="modal" data-id="<?php echo $patient->id; ?>"><i><img alt="" src="uploads/edit-bttn-icon.png"  class="files-edit-but" ><?php echo lang('edit'); ?></a>
                                        ...
                                        <a class="btn delete_button" title="<?php echo lang('delete'); ?>" href="patient/delete?id=<?php echo $patient->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i><img alt="" src="uploads/trash-bttn-icon.png"  class="files-trash-but" > </i> <?php echo lang('delete'); ?></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editPatientForm" action="patient/addNew" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"><?php echo lang('email'); ?></label>
                        <input type="text" class="form-control" name="email" id="exampleInputEmail1" value='' placeholder="" autocomplete="new-username">
                    </div>
