...
<section id="main-content">
    <section class="wrapper site-min-height" style="background-color: #f3f3f3;">
        <!-- page start-->
        <section class="">

            <header class="panel-heading">
            <div class="col-md-6 patient_list">
                <i ><img alt="" src="uploads/Patient-List-B-S.png"  class="doc-list-doc-img"></i>   
                <div><?php echo lang('patient'); ?> <?php echo lang('list'); ?> </div>
            </div>
...
<!-- Add Patient Modal-->
<div class="modal fade test" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop='static' data-keyboard='false' style="display: none;">
                ...
                <form role="form" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-otp">
                        <div class="form-group col-md-6">
                            <label for="email"><?php echo lang('email'); ?><sup>*</sup></label>
                            <input type="email" class="form-control" name="email" id="email" placeholder="" autocomplete="new-email">
                        </div>
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail dept-add-spec-fileupload1" >
                                    <img data-enlargable  src="//www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="" />
                                </div>
...
$(document).ready(function()
{
    ...
    $("#myModal").click(function(){ 
        if(! mouse_is_inside) $('#myModal').show();
    });
});
</script>
<!-- Add Patient Modal-->
            ...
            <div class="modal-body row">
                <form role="form" id="editPatientForm" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="email" id="email_otp" value='' placeholder="" autocomplete="new-username">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="exampleInputEmail1"></label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('phone'); ?><sup>*</sup></label>
                        <input type="text" class="form-control" name="phone" id="phone_otp" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="exampleInputEmail1"></label>
                    ...
                    <label class="control-label"><?php echo lang('image'); ?><?php echo lang('upload'); ?></label>
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail dept-add-spec-fileupload1">
                                    <img data-enlargable src="//www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" id="img" alt="" />
                                </div>
                                <div class="fileupload-preview fileupload-exists thumbnail dept-add-spec-fileupload"></div>
                                <div>
                                    <span class="btn btn-white btn-file">
