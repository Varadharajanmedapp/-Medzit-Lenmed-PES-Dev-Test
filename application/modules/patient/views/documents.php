...
<section id="main-content">
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            ...
            <i ><img alt="" src="uploads/documents-main.png" class="doc-list-doc-img"  ></i> <?php echo lang('patient'); ?>  <?php echo lang('documents'); ?> 
            </div>
                        ...
                        <table class="table table-striped table-hover table-bordered table-row1" id="editable-sample">
                            <thead>
                                <tr>
                                    ...
                                    <th class="doc-tab-document"><?php echo lang('document'); ?></th>
