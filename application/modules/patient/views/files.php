                            ...
                            <tbody>
                                <?php foreach ($medical_histories as $medical_history) { ?>
                                    <tr class="">
                                        ...
                                        <td class="no-print">
                                            <button type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" data-id="<?php echo $medical_history->id; ?>"><i><img alt="" src="uploads/edit-bttn-icon.png" class="files-edit-but"> </i><?php echo lang('edit'); ?></button>   
                                            <a class="btn btn-info btn-xs btn_width delete_button" href="medical_history/delete?id=<?php echo $medical_history->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><img alt="" src="uploads/trash-bttn-icon.png" class="files-trash-but"><?php echo lang('delete'); ?></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                    ...
                    <div class="adv-table editable-table ">
                        ...
                        <div class="panel-body">
                            <?php foreach ($patient_materials as $patient_material) { ?>
                                <div class="panel col-md-3 files-panel-col-md-3" >
