            ...
            <header class="panel-heading">
                    ...
                    <a data-toggle="modal" href="#myModal">
                        <div class="btn-group">
                            <button id="" class="btn btn-xs green">
                                <i class="fa fa-plus-circle patient-payment-fafa-icon"></i>  <?php echo lang('deposit'); ?>
                            </button>
                        </div>
                    </a>   
                </div>
                ...
                <div class="panel-body no-print pull-right">
                    <a data-toggle="modal" href="#myModal5">
                        <div class="btn-group">
                            <button id="" class="btn btn-xs green">
                                <i class="fa fa-file patient-payment-fafa-icon" ></i> <?php echo lang('invoices'); ?>
                            </button>
                        </div>
                    </a>   
                </div>
            ...
            <div class=" panel-body"  >
                <div class="adv-table editable-table ">
                    <section class="col-md-12 no-print row">
                        <form role="form" class="f_report f_report1" action="/finance/patientPaymentHistory" method="post" enctype="multipart/form-data">
                            ...
                            foreach ($payments as $payment) {
                                if ($payment->date == $value) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td  class="no-print"> 
                                            <a class="btn-xs invoicebutton invoice-button1" title="<?php echo lang('invoice'); ?>" href="patient/myInvoice?id=<?php echo $payment->id; ?>"><i class="fas fa-file-invoice"></i> </a>
                                        </td>
                                    </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body col-md-12 invoice-panel-col-md-5">
