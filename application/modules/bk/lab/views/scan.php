...
<section id="main-content">
 ...
 -->            
                                <div class="col-md-6 lab pad_bot">
                                    ...
                                    <input type="text" class="form-control m-bot15" name="type" value="<?php echo $appointments->type; ?>">
                                ...
                                <textarea class="form-control" id="editor" name="report_link" value="" rows="10"><?php 
                                    if (!empty($setval)) {
                            ...
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                ...
                                <div>
                                    <span class="btn btn-white btn-file">
                                        ...
                                        <span class="fileupload-exists"><i class="fa fa-undo"></i> <?php echo lang('Change'); ?></span>
                                        <input type="file" name="report_pdf" class="default" accept="application/pdf,application/vnd.ms-excel" />
                                    </span>
                                    <span class="btn btn-danger fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash"></i> <?php echo lang('Remove'); ?></span>
                                </div>
                            </div>
