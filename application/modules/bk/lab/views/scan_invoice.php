                ...
                <div class="panel-body" style="font-size: 10px;">
                    <div class="row invoice-list">
                        ...
                        <div class="text-center corporate-id">
                            ...
                            <img alt="" src="<?php echo $hos_details->img_url; ?>" width="200" height="100">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6 pull-right" style="text-align: left;">
                                ...
                                <div class="col-md-12 row details">
                                 ...
                                 <div class="col-md-12 row details">
                                    <label class="control-label">Report Image : </label>
                                    <div class="">
                                ...
                                <div class="col-md-12 row details">
                                    <p>
                                        <label class="control-label"><?php echo lang('report_pdf'); ?>  </label>
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($lab->date)) {
                                                echo date('d-m-Y', $lab->date) . ' <br>';
                            ...
                            <div class="col-md-12 row details">
                              <p>
                                <label class="control-label"><?php echo lang('reports'); ?>  </label>
                                <span style="text-transform: uppercase;"> : 
                                    <?php
                        if (!empty($lab->report)) {
                            echo $lab->report;
