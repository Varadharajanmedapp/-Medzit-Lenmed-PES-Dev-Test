    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
              <i class="fas fa-money-bill-alt"></i>   <?php  echo lang('treatment_history'); ?>
            </header>
                        ...
                        <?php foreach ($doctors as $doctor) { ?>
                            ...
                            <tr class="">
                                ...
                                <td>
                                 ...
                                 <td> <a class="btn btn-info btn-xs btn_width add_payment_button" style="width: 100px;" href="appointment/getAppointmentByDoctorId?id=<?php echo $doctor->id; ?>"><i class="fas fa-money-bill-alt"></i>  <?php  echo lang('details'); ?></a></td>
