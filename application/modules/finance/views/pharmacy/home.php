...
<section id="main-content"> 
    ...
    <section class="wrapper site-min-height">           
        ...
        <div class="col-md-12">
            ...
            <div class="row state-overview pharmacy-overview">
                <div class="col-lg-3 col-sm-6">
                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                        <a href="finance/pharmacy/todaySales">
                        <?php } ?>
                        <section class="panel panel-moree">
                            <div class="pharmacy symbol terques">
                ...
                <div class="col-lg-3 col-sm-6">
                    <?php if ($this->ion_auth->in_group('admin')) { ?>
                        ...
                        <?php } ?>
                        <section class="panel panel-moree">
                            <div class="pharmacy symbol blue">
                ...
                <div class="col-md-6">
                    <!--work progress start-->
                    <section class="panel home-panel1" >
                        <div class="progress-panel sec-panel-body-bg" >
                        ...
                        <table class="table table-hover personal-task">
                            <tbody>  
                                <tr>
                                    ...
                                    <td>
                                        <div id="work-progress1"><canvas width="47" height="20" class="work-pro-gress-home1"></canvas></div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="work-progress2"><canvas width="47" height="22" class="work-pro-gress-home2"></canvas></div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="work-progress3"><canvas width="47" height="22" class="work-pro-gress-home2"></canvas></div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div id="work-progress4"><canvas width="47" height="22" class="work-pro-gress-home2"></canvas></div>
                                    </td>
                                </tr>
