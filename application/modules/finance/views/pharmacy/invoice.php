    ...
    <section class="wrapper site-min-height">
        ...
        <section>
            <div class="panel panel-primary">
                ...
                <div  class="panel-body col-md-5 panel-moree invoice-panel-col-md-5" id="invoice" >
                    <div class="row invoice-list">
                        ...
                        <div class="col-lg-4 col-sm-4">
                            ...
                            <ul class="unstyled">
                                ...
                                <li> <?php echo lang('appointment_id'); ?> 		: <strong><?php echo $payment->appointment_id; ?></strong></li>
                ...
                <div class="col-md-5 panel-moree invoice-panel-col-md-5" >
