    ...
    <section class="wrapper site-min-height">
        ...
        <section class="no-print col-md-8">
            <header class="panel-heading">
                ...
                <div class="panel-body no-print pull-right sec-panel-body-bg" >
            ...
            <div class=" panel-body" >
                <div class="adv-table editable-table ">
                    ...
                    <div  class="table table-striped table-hover table-bordered-1">
                        <thead>
                            <tr class="table-heading-title" >
                                    ...
                                    <tr class="table-heading-title" >
                                        ...
                                        <td  class="no-print"> 
                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                                                <a class="btn-xs btn-info" title="<?php echo lang('edit'); ?>" style="width: 25%;margin-right: 4px; padding-right: 5px;" href="finance/editPayment?id=<?php echo $payment->id; ?>"><i><img alt="" src="uploads/edit-bttn-icon.png" class="files-edit-buttton"></i></a>
                                            <?php } ?>
                                            <a class="btn-xs invoicebutton" title="<?php echo lang('invoice'); ?>" style="color: #fff; width: 25%;margin-right: 4px; padding-right: 5px;" href="finance/invoice?id=<?php echo $payment->id; ?>"><i class="fa fa-file-invoice"></i> </a>
                                            <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?> 
                                                <a class="btn-xs btn-info delete_button" title="<?php echo lang('delete'); ?>" style="width: 25%;border-radius:0px;margin-right: 4px; padding-right: 5px;"  href="finance/delete?id=<?php echo $payment->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i ><img alt="" src="uploads/trash-bttn-icon.png" class="files-trash-but"></i> </a>
                                            <?php } ?>
                                            </button>
                                        </td>
                                    </tr>
                                ...
                                if ($deposit->date == $value) {
                                    if (!empty($deposit->deposited_amount) && empty($deposit->amount_received_id)) {
                                        ...
                                        <tr class="">
                                            ...
                                            <td  class="no-print"> 
                                                <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                                                    <button type="button" class="btn-xs btn-info editbutton" title="<?php echo lang('edit'); ?>" style="width: 20%;margin-right: 4px; padding-right: 5px;border:none;border-radius: 0px;" data-toggle="modal" data-id="<?php echo $deposit->id; ?>"><i><img alt="" src="uploads/edit-bttn-icon.png" class="files-edit-buttton"></i> </button> 
                                                <?php } ?>
                                                <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?> 
                                                    <a class="btn-xs btn-info delete_button" title="<?php echo lang('delete'); ?>" style="width: 25%;border-radius:0px;margin-right: 4px; padding-right: 5px;" href="finance/deleteDeposit?id=<?php echo $deposit->id; ?>&patient=<?php echo $patient->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i ><img alt="" src="uploads/trash-bttn-icon.png" class="files-trash-but"></i></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php
        ...
        <section class="no-print col-md-4">
            ...
            <div class="">
                ...
                <section class="panel red panel-red1--" >
                    <div class="weather-bg">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-4">
            ...
            <div class="modal-body">
                <div class="clearfix">
                    <div class="col-lg-12 clearfix">
                        <a href="finance/addPaymentByPatientView?id=<?php echo $patient->id; ?>&type=gen">
                            <div class="col-lg-6">
                                <div class="flat-carousal flat-carousal1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <div class="panel panel-primary">
                    ...
                    <div class="panel invoice-panel-col-md-5"  id="invoice" >
                        <div class="row invoice-list">
                            ...
                            <div class="col-lg-4 col-sm-4 payment_to-col">
