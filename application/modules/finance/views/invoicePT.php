                ...
                <div class="panel-body col-md-6">
                    ...
                    <div class="row">
                        <div class="col-lg-4 invoice-block pull-right">
                            <ul class="unstyled amounts">
                                ...
                                <?php } ?>
                                <li class="li_bg_green"><strong>Total : </strong><?php echo $settings->currency; ?> <?php
                    ...
                    <?php } ?>
                      ...
                      <div class="row">
                        <div class="col-lg-4 invoice-block pull-right">
                            <ul class="unstyled amounts">         
                                <li class="li_bg_green1"><strong>Total Amount To Be Paid : </strong><?php echo $settings->currency; ?> <?php
                  ...
                  <div class="panel-body col-md-6 invoice-panel-col-md-6" >
