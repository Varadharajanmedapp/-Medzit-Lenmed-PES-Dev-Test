    ...
    <section class="wrapper site-min-height">
        ...
        <section>
            <div class="panel panel-primary">
                ...
                <div class="panel-body col-md-5 expense-panel-col" id="invoice">
                    ...
                    <div class="row">
                        <div class="col-lg-4 invoice-block pull-right">
                            <ul class="unstyled amounts">
                                <li><strong class="invoice-form-style"><?php echo lang('sub_total'); ?> : </strong><?php echo $settings->currency; ?> <?php echo $expense->amount; ?></li>
                                <li><strong class="invoice-form-style"><?php echo lang('grand_total'); ?> : </strong><?php echo $settings->currency; ?> <?php echo $expense->amount; ?></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md-6 invoice-panel-col-md-6">
