    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
               <i class="fas fa-money-bill-alt"></i>  <?php echo lang('amount_distribution'); ?>
            </header>
                        ...
                        <?php foreach ($payments as $payment) { ?>
                            ...
                            <tr class="">
                                ...
                                <td class="no-print"> 
                                    ...
                                    <a class="btn btn-xs invoicebutton width_auto detailsbutton1"  href="finance/invoice?id=<?php echo $payment->id; ?>"><i class="fa fa-file-text"></i> <?php echo lang('invoice'); ?></a>
                                    <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
