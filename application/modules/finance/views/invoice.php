    ...
    <section class="wrapper site-min-height">
        ...
        <section class="col-md-6">
            <div class="panel panel-primary" id="invoice">
                ...
                <div class="panel-body expense-panel-col" >
                    <div class="row invoice-list">
                        ...
                        <div class="col-md-12">
                            <h4 class="text-center text-center1" >
                    ...
                    <div class="">
                        <div class="col-lg-4 invoice-block pull-right">
                            <ul class="unstyled amounts">
                                <li ><strong class="invoice-form-style"><?php echo lang('sub_total'); ?> : </strong><?php echo $settings->currency; ?> <?php echo $payment->amount; ?></li>
                                ...
                                <?php } ?>
                                <li><strong class="invoice-form-style"><?php echo lang('grand_total'); ?> : </strong><?php echo $settings->currency; ?> <?php echo $g = $payment->gross_total; ?></li>
                                <li><strong class="invoice-form-style"><?php echo lang('amount_received'); ?> : </strong><?php echo $settings->currency; ?> <?php echo $r = $this->finance_model->getDepositAmountByPaymentId($payment->id); ?></li>
                                <li><strong class="invoice-form-style"><?php echo lang('amount_to_be_paid'); ?> : </strong><?php echo $settings->currency; ?> <?php echo $g - $r; ?></li>
                            </ul>
                        </div>
                    </div>
