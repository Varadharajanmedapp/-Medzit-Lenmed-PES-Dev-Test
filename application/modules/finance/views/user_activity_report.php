        ...
        <section class="panel">
            ...
            <div class="col-md-6">
                <section class="col-md-5 pull-left row">
                    <?php echo lang('activities_by'); ?> <strong class="payment_activity"  ><?php echo $user->name; ?></strong>
                    ( <?php
                    if (!empty($date_from)) {
                ...
                <?php if ($this->ion_auth->in_group(array('admin')) || $this->ion_auth->get_user_id() == '341') { ?>
                    <section class="col-md-4 no-print row payment_user_act_col" >
            ...
            <div class="col-md-8 row">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered table-row1" id="editable-samples">
                        <thead>
                            <tr>
